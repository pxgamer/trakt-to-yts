...
{
    /** {@inheritdoc} */
    protected $signature = 'download { trakt-user : The Trakt username for the list }
                                     { --key= : Your Trakt API key (defaults to use the `TRAKT_API_KEY` environment variable if not provided) }
